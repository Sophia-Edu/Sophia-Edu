			...
			<div className="container mx-auto px-0 sm:px-4 p-4">
				<div className="mb-[30px] grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
					<div className="flex items-center px-[20px] gap-2 h-[100px] bg-white rounded-[8px] border-[#DBDBDB] border-1">
						<StudentsIcon2 />
						<div>
							<p className="text-[16px] inter-normal">Total Students</p>
					...
					<div className="flex items-center px-[20px] gap-2 h-[100px] bg-white rounded-[8px] border-[#DBDBDB] border-1">
						...
						<div>
							<p className="text-[16px] inter-normal">Total Instructors</p>
							<p className="font-medium text-[18px]">500</p>
						</div>
					</div>
					<div className="flex items-center px-[20px] gap-2 h-[100px] bg-white rounded-[8px] border-[#DBDBDB] border-1">
						<SquaredBook />
						<div>
							<p className="text-[16px] inter-normal">Total Courses</p>
							<p className="font-medium text-[18px]">500</p>
						</div>
					</div>
					<div className="flex items-center px-[20px] gap-2 h-[100px] bg-white rounded-[8px] border-[#DBDBDB] border-1">
						<SquaredDollarIcon />
						<div>
							<p className="text-[16px] inter-normal">Total Earnings</p>
							<p className="font-medium text-[18px]">$500</p>
						</div>
					</div>
				</div>
